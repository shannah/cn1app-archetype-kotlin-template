 ...
 * @author Shai Almog
 */
public class ExampleKotlinAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "ExampleKotlinApp";
    ...
    private ExampleKotlinApp mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new ExampleKotlinAppStub());
    }
