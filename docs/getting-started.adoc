...
Right click on the project in the project inspector, and select "Run Maven" > "Build iOS App" as shown below:

image::images/netbeans-build-ios-app.png[]
...
Right click on the project in the project inspector, and select "Run Maven" > "Build iOS App (Release)" as shown below:

image::images/netbeans-build-ios-app-release.png[]
...
Additionally you need to have the following environment variables set:
...
Right click on the project in the project inspector, and select "Run Maven" > "Build Android App" as shown below:

image::images/netbeans-build-android.png[]
...
Right-click on the project in the project inspector, and select "Run Maven" > "Build Mac Desktop App" as shown below:

image::images/netbeans-buld-mac.png[]
...
Right-click on the project icon in the project inspector, and select "Run Maven" > "Build Windows Desktop App" as shown below:

image::images/netbeans-windows-desktop-build.png[]
...
Right-click on the project icon in the project inspector, and select "Run Maven" > "Build Windows UWP App"

image::images/netbeans-windows-uwp-build.png[]
...
Right-click on the project icon in the project inspector, and select "Run Maven" > "Build Web App"

image::images/netbeans-build-web-app.png[]
